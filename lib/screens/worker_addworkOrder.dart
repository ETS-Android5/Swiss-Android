...
class WorkerShtoTikete extends StatefulWidget {
  final String clientId;

  WorkerShtoTikete({Key key, this.clientId}) : super(key: key);

  @override
  _WorkerShtoTiketeScreenState createState() => _WorkerShtoTiketeScreenState();
}

class _WorkerShtoTiketeScreenState extends State<WorkerShtoTikete> {
  ...
  void didChangeDependencies() {
    if (isInit) {
      ...
      Provider.of<JobProvider>(context, listen: false)
          .getAllProdByIdDropDown(this.widget.clientId)
          .then((value) {
        setState(() {
          isInit = false;
        });
          ...
          child: Column(
            ...
            children: [
              ...
              DateTimePicker(
                ...
                onChanged: (val) => {_selectedETAtime = val},
                validator: (val) {
                  print(val);
                  return null;
                },
  ...
  Widget _serialNumber() {
    final serialNumber = Provider.of<JobProvider>(context).serialNumbers;
    return new Container(
        child: new InputDecorator(
          decoration: InputDecoration(
              suffixIcon: new Icon(
