...
class Auth with ChangeNotifier {
  ...
  Future<void> editPersonalInfo(String newName, String newMobile,
      String newGender, String newAccountHolder) async {
    ...
    final oldAccountHolder = _currentUser.accountHolder;
    _currentUser.name = newName;
    _currentUser.mobile = newMobile;
    _currentUser.gender = newGender;
    _currentUser.accountHolder = newAccountHolder;
    notifyListeners();
    var url = '$base_url/editPersonalInfo';
    try {
      final response = await http.post(
      ...
      if (body['message'] != 'Profile has been updated successfully') {
        ...
        _currentUser.accountHolder = oldAccountHolder;
        notifyListeners();
      } else {
        final prefs = await SharedPreferences.getInstance();
        prefs
    ...
    try {
      ...
      if (responseData['message'] != null &&
        ...
        final user = User(
          ...
          accountHolder: responseData['data']['account_holder_name'] ?? '',
  ...
  Future<bool> tryAutoLogin() async {
    ...
    final user = User(
      ...
      accountHolder: extractedUserData['account_holder_name'] ?? '',
  ...
  // Future<FirebaseUser> _checkLoginState() async {
